...
run_agent("What is the height of Mount Everest in metres divided by 3?")
time.sleep(20)
run_agent("How many years have passed since Pakistan gained independence?")
time.sleep(20)
run_agent("What is the area of Pakistan divided by its population?")