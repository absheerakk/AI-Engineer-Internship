...
# Define Hardened System Prompt globally (Separated like in Day 10)
...
# Cache the Generative Model using gemini-2.5-flash-lite and global SYSTEM_PROMPT
@st.cache_resource
def load_llm():
...
# Cache the Scope Checker Model using gemini-2.5-flash
@st.cache_resource
