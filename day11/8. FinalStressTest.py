...
def run_agent(question, max_steps=6):
    ...
    for step in range(1, max_steps + 1):
        ...
        if not reply:
            return "I was unable to process this request."
        # ----------------------------
...
if __name__ == "__main__":
    run_agent("What is the population of Zibbleforth?")
    time.sleep(15)
    run_agent("Summarise the entire history of the universe in one sentence.")
    time.sleep(15)
